...
export const Icons = {
    ...
    follow: ({ ...props }: IconProps) => (
        <svg aria-label="Profile" fill="currentColor" height="26" role="img" viewBox="0 0 26 26" width="26" {...props}><title>Profile</title>
    ...
    circleMenu: (props: IconProps) => (
        <svg aria-label="More" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"{...props}>
            ...
            <path clip-rule="evenodd" d="M16.5 13.5C15.6716 13.5 15 12.8284 15 12C15 11.1716 15.6716 10.5 16.5 10.5C17.3284 10.5 18 11.1716 18 12C18 12.8284 17.3284 13.5 16.5 13.5Z" fillRule="evenodd">
            </path>
        </svg>
    ),
    ...
    home: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
        <svg aria-label="Home" width="24" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <title>Home</title>
